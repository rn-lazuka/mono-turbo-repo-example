...
export function BUSDIcon(props: SvgIconProps) {
  return (
    <SvgIcon x="0px" y="0px" viewBox="0 0 2500 2500" {...props}>
      <g id="Layer_x0020_1">
        <g id="_2085562936336">
          <path
            fill="#F0B90B"
            d="M1250,0c690.3,0,1250,559.7,1250,1250s-559.7,1250-1250,1250S0,1940.3,0,1250S559.7,0,1250,0z"
          ></path>
          <path
            fill="#FFFFFF"
